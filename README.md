...
- 一个 Discord Bot Token 和允许运行的 Server（Guild）ID
  - 需要开启 Gateway Intents：`GUILDS`、`GUILD_MESSAGES`、`MESSAGE_CONTENT`
  - 需要权限：View Channels、Send Messages、Send Messages in Threads、Create Public Threads、Read Message History、Embed Links、Attach Files
