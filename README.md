...
| `claude-code` | `claude -p`<br>✅ | `--resume <id>`<br>✅ | `--output-format stream-json --verbose --include-partial-messages`<br>✅ 支持 token 级流式（text/thinking delta） | `--permission-mode bypassPermissions`<br>✅ | ✅ |
